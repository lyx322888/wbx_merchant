...
import com.wbx.merchant.widget.refresh.view.FooterView;
import com.wbx.merchant.widget.refresh.view.HeadRefreshView;
import com.wbx.merchant.widget.refresh.view.HeadView;
import com.wbx.merchant.widget.refresh.view.LoadMoreView;
...
public class PullToRefreshLayout extends FrameLayout {
    ...
    private void showLoadingView() {
        if (loadingView == null) {
            ...
            ImageView loadingIm = (ImageView) loadingView.findViewById(R.id.loading_im);
            AnimationDrawable drawable = (AnimationDrawable) loadingIm.getDrawable();
            drawable.start();
    ...
    //无网络时候反射机制请求
    public void buttonClickError(final Object base, final String method,
                            final Object... parameters) {
        errorView.findViewById(R.id.error_refresh).setOnClickListener(new OnClickListener() {
    ...
    //无数据时候反射机制再次请求
    public void buttonClickNullData(final Object base, final String method,
                                 final Object... parameters) {
        emptyView.findViewById(R.id.try_again_tv).setOnClickListener(new OnClickListener() {
            public void onClick(View v) {
                showView(ViewStatus.LOADING_STATUS);
                int length = parameters.length;
                Class[] paramsTypes = new Class[length];
