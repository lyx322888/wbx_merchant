 ...
 * @author zhangqie
 */
public class MyImagView extends AppCompatImageView {
    ...
    public MyImagView(Context context, AttributeSet attrs, int defStyle) {
