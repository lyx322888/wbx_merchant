...
public class CustomizedProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mPaint.setColor(getResources().getColor(R.color.white)); //设置边框背景颜色
    ...
    private LinearGradient getLinearGradient() {
        if (linearGradient == null) {
            linearGradient = new LinearGradient(0, 0, getWidth(), mHeight, new int[]{mContext.getResources().getColor(R.color.white),
                    mContext.getResources().getColor(R.color.progress_color_1)}, null, Shader.TileMode.CLAMP); //根据R文件中的id获取到color
        }
