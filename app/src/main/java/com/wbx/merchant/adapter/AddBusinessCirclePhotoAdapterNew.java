...
public class AddBusinessCirclePhotoAdapterNew extends RecyclerView.Adapter<AddBusinessCirclePhotoAdapterNew.MyViewHolder> {
    private IssueSqActivity mContext;
    private List<String> lstData = new ArrayList<>();

    public AddBusinessCirclePhotoAdapterNew(IssueSqActivity context) {
        mContext = context;
    }
