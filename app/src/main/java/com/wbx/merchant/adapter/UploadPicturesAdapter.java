...
import com.wbx.merchant.activity.jhzf.UploadPicturesActivity;
...
public class UploadPicturesAdapter extends RecyclerView.Adapter<UploadPicturesAdapter.MyViewHolder> {
    private UploadPicturesActivity mContext;

    private List<String> lstData;

    public UploadPicturesAdapter(UploadPicturesActivity context, List<String> data) {
        mContext = context;
        lstData = data;
    }
