...
public class SeckillAdapter extends BaseAdapter<GoodsInfo, Context> {
    ...
    public void convert(BaseViewHolder holder, GoodsInfo goodsInfo, int position) {
        ...
        holder.setText(R.id.product_name_tv, goodsInfo.getProduct_name())
                .setText(R.id.seckill_price_tv, Html.fromHtml("秒杀价:<font color = #ff0000 size=16> " + String.format("%s", goodsInfo.getSeckill_price()) + "</font>"));
