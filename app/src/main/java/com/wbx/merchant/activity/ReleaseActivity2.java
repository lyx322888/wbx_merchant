...
public class ReleaseActivity2 extends BaseActivity implements OptionsPickerView.OnOptionsSelectListener {
    ...
    public void initView() {
        ...
        //商品分类
        catePickerView = new OptionsPickerView.Builder(mContext, ReleaseActivity2.this).build();
        //商品图片(头部)
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            imageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    GoodsPictureActivity.actionStart(ReleaseActivity2.this, lstGoodsPic, position);
                }
            });
    ...
    private void doRelease() {
        ...
        float casing = TextUtils.isEmpty(etPackingFee.getText().toString().trim()) ? 0.0f : Float.valueOf(etPackingFee.getText().toString().trim());//包装费
        mParams.put("casing_price", casing);//包装费
        mGoodInfo.setCasing_price(casing * 100);
        ...
        new MyHttp().doPost(Api.getDefault().releaseGoods(mParams), new HttpListener() {
            ...
            public void onSuccess(JSONObject result) {
                ...
                showShortToast(mGoodInfo == null ? "商品添加成功！" : "更改成功！");
    ...
    private String addNature() {
        if (mGoodInfo != null && mGoodInfo.getNature().size() > 0) {
